...
# RSpec.describe Admins::SuggestionsController, type: :controller do
...
#         post :create, {:suggestion => valid_attributes}, valid_session
#         expect(response).to redirect_to(Suggestion.last)
#       end
#     end

#     context "with invalid params" do
#       it "assigns a newly created but unsaved suggestion as @suggestion" do
#         post :create, {:suggestion => invalid_attributes}, valid_session
#         expect(assigns(:suggestion)).to be_a_new(Suggestion)
#       end
...
#         suggestion = Suggestion.create! valid_attributes
#         put :update, {:id => suggestion.to_param, :suggestion => new_attributes}, valid_session
#         suggestion.reload
...
#         suggestion = Suggestion.create! valid_attributes
#         put :update, {:id => suggestion.to_param, :suggestion => invalid_attributes}, valid_session
#         expect(assigns(:suggestion)).to eq(suggestion)
#       end
