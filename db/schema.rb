...
ActiveRecord::Schema.define(version: 20161008024936) do
  ...
  create_table "user_cards", force: :cascade do |t|
    t.integer  "user_id"
    t.integer  "card_id"
    t.string   "encrypt_code"
    t.datetime "created_at",   null: false
    t.datetime "updated_at",   null: false
  end

  add_index "user_cards", ["card_id"], name: "index_user_cards_on_card_id", using: :btree
  add_index "user_cards", ["encrypt_code"], name: "index_user_cards_on_encrypt_code", using: :btree
